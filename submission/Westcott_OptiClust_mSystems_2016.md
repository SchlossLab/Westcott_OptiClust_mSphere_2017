...
***Data and code availability.*** The workflow utilized commands in GNU make (v.3.81), GNU bash (v.4.1.2), mothur [v.1.39.0; @Schloss2009], and R [v.3.3.0; @language2015]. Within R we utilized the wesanderson [v.X.X.X; @XXXXXX], dplyr [v.X.X.X; @XXXXXX], tidyr [v.X.X.X; @XXXXXX], cowplot [v.X.X.X; @XXXXXX], and ggplot2 [v.X.X.X; @XXXXXX] packages. A reproducible version of this manuscript and analysis is available at https://github.com/SchlossLab/Westcott_OptiClust_mSystems_2015.
