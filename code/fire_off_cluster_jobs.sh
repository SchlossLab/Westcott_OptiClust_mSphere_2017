...
make data/$LIBRARY/$LIBRARY.$F.$R.mcc_agg.$TYPE;
...
make data/$LIBRARY/$LIBRARY.$F.$R.vdgc_split2_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.vdgc_split3_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.vdgc_split4_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.vdgc_split5_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.vdgc_split6_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.an_split2_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.an_split3_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.an_split4_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.an_split5_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.an_split6_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.mcc_split2_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.mcc_split3_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.mcc_split4_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.mcc_split5_8.$TYPE;
make data/$LIBRARY/$LIBRARY.$F.$R.mcc_split6_8.$TYPE;
